 ...
 * b |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
 *   +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+    A (x##) Main (Havens)
 * c |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |    B (x##) Main (1st Flr Ctr)
 *   +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+    C (x##) East (1st Flr Ctr)
 * d |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |    D (x##) Hunt (1st Flr Ctr)
 *   +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+    E (x##) Library (Entrance)
 * e |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |    F (x##) Kelley (Elevator x 2)
 *   +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+    G (x##) SAEC (Gym)
...
public class GridMapper
{
  ...
  public static void drawGrid()
  {
    ...
    mapPins[0][0] = 40.46046;  // Lat A:  Main (Havens)
    mapPins[0][1] = -86.13328; // Long A: Main (Havens)
    mapPins[1][0] = 40.4602;   // Lat B:  Main (1st Flr Ctr)
    mapPins[1][1] = -86.13246; // Long B: Main (1st Flr Ctr)
    mapPins[2][0] = 40.46;     // Lat C:  East (1st Flr Ctr)
    mapPins[2][1] = -86.13105; // Long C: East (1st Flr Ctr)
    mapPins[3][0] = 40.45971;  // Lat D:  Hunt (1st Flr Ctr)
    mapPins[3][1] = -86.13014; // Long D: Hunt (1st Flr Ctr)
    mapPins[4][0] = 40.45903;  // Lat E:  Library (Entrance)
    mapPins[4][1] = -86.13148; // Long E: Library (Entrance)
    mapPins[5][0] = 40.45923;  // Lat F:  Kelley (Elevator x 2)
    mapPins[5][1] = -86.13137; // Long F: Kelley (Elevator x 2)
    mapPins[6][0] = 40.45809;  // Lat G:  SAEC (Gym)
    mapPins[6][1] = -86.13037; // Long G: SAEC (Gym)
    mapPins[7][0] = 40.45803;  // Lat H:  Observatory (Lobby)
    mapPins[7][1] = -86.13055; // Long H: Observatory (Lobby)
    mapPins[8][0] = 40.45621;  // Lat I:  Early Outreach
    mapPins[8][1] = -86.12758; // Long I: Early Outreach
    mapPins[9][0] = 40.45621;  // Lat J:  Fine Arts (Lobby)
    mapPins[9][1] = -86.12745; // Long J: Fine Arts (Lobby)
  ...
  public static void appendTextColumn(int i, String[] gridTags)
  {
    switch(i)
    {
      ...
      case 4:   System.out.print("\tA (" + gridTags[0] + "Main (Havens)\n");
                break;
      case 5:   System.out.print("\tB (" + gridTags[1] + "Main (1st Flr Ctr)\n");
                break;
      case 6:   System.out.print("\tC (" + gridTags[2] + "East (1st Flr Ctr)\n");
                break;
      case 7:   System.out.print("\tD (" + gridTags[3] + "Hunt (1st Flr Ctr)\n");
                break;
      case 8:   System.out.print("\tE (" + gridTags[4] + "Library (Entrance)\n");
                break;
      case 9:   System.out.print("\tF (" + gridTags[5] + "Kelley (Elevator x 2)\n");
                break;
      ...
      case 33:  System.out.print("\tFine Arts AED is\n");
                break;
      case 34:  System.out.print("\t2241.2 ft\n");
                break;
